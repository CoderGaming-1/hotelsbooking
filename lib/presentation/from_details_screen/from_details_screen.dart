...
import '../../widgets/custom_elevated_button.dart'; import '../../widgets/custom_text_form_field.dart';
...
class FromDetailsScreen extends StatelessWidget {
  ...
  static Widget builder (BuildContext context) {
    return BlocProvider<FromDetailsBloc>(
      create: (context) =>
      FromDetailsBloc(FromDetailsState(
  ...
  Widget _buildDateSelection (BuildContext context) {
    return SizedBox( width: double.maxFinite,
        ...
        SizedBox (height: 8.h),
        BlocSelector<FromDetailsBloc, FromDetailsState, TextEditingController?>(
