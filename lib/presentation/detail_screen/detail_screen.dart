...
class DetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        ...
        SizedBox(height: 12.h),
        _buildHotelInfoRow(context), _buildUserInfoRow(context),
        SizedBox(height: 4.h),
        Text(
        "lbl_description".tr,
    ...
    Widget _buildReviewButton(BuildContext context) {
        ...
        child: BlocSelector<DetailsBloc, DetailsState, TextEditingController?>(
          ...
          builder: (context, breakfastInputController) {
            return CustomTextFormField(
              ...
              prefixConstraints: BoxConstraints(maxHeight: 36.h,),
              // contentPadding: EdgeInsets.fromLTRB(12.h, 8.h, 12.h, 8.h),
              width: 200.0,
              contentPadding: EdgeInsets.symmetric(horizontal: 8.h, vertical: 6.h),
              borderDecoration: TextFormFieldStyleHelper.fillGrayB,
              filled: true,
              fillcolor: appTheme.gray50B2,
            );
      ...
      Widget _buildTabsRow(BuildContext context) {
        return SizedBox(
            ...
            child: Row(
            children: [
            _buildFreeWifiButton (context), SizedBox (width: 8.h),
            _buildBreakfastInput (context), SizedBox(width: 8.h),
  ...
  Widget _buildHotelInfoRow(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text( "msg_the_aston_vil_hotel".tr,
  ...
  Widget _buildUserInfoRow (BuildContext context) {
    return SizedBox(
      ...
      Padding(
        ...
        child: Text( "msg_upper_indira_nagar".tr,
